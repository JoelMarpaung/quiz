...
<head>
        <title>Quiz Engine Builder Admin</title><meta charset="UTF-8" />
    ...
    <body>
        <div id="loginbox">            
            <form id="loginform" class="form-vertical" method="post" action="{{ url('admin')}}">
				 ...
				 <div class="control-group normal_text"> <h3><img src="{{ asset('images/backend_images/logo_.png') }}" alt="Logo" /></h3></div>
                ...
                <div class="form-actions">
                    ...
                    <span class="pull-right"><input type="submit"  value="Login" class="btn btn-success" /> Login</a></span>
                </div>
            </form>
