...
@section('content')
    ...
    {!! Form::model($multiple_options, ['method' => 'PUT', 'route' => ['multiple_options.update', $multiple_options->id]]) !!}
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('question_id', $multiple_choice, old('question_id'), ['class' => 'form-control']) !!}
